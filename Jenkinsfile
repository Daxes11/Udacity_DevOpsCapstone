    ...
    stages {
        ...
        stage('Push Docker image to ECR') {
            steps {
                ...
                sh 'export image="586771751035.dkr.ecr.us-east-1.amazonaws.com/udacity_capstone:$BRANCH_NAME"'
                sh 'docker tag udacity_capstone:latest 586771751035.dkr.ecr.us-east-1.amazonaws.com/udacity_capstone:$BRANCH_NAME'
